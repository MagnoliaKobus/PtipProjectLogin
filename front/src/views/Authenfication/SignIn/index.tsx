        ...
        <div id="sign-in-wrapper">
            ...
            <div className='sign-in-container'>
                <div className='sign-in-box'>
                    <div className='sign-in-title'>{'피팁 테스트'}</div>
                    <div className='sign-in-content-box'>
                        ...
                        <div className='sign-in-content-input-box'>
                            ...
                            <InputBox ref={passwordRef} title='비밀번호' placeholder='비밀번호를 입력해주세요.' type='password' value={password} onChange={onPasswordChangeHandler} isErrorMessage message={message} onKeydown={onPasswordKeyDownHandler} ></InputBox>
                        </div>
                        ...
                        <div className='sign-in-content-sns-sign-in-box'>
                            ...
                            <div className='sign-in-content-sns-sign-in-botton-box'>
