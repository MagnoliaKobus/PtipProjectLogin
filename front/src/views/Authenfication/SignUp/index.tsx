...
export default function SignUp() {
    ...
    const [isCertificationNumber, setCertificationNumberError] = useState<boolean>(false);
    ...
    const checkCertificationResponse = (responseBody: ResponseBody<EmailCertificationResponseDto>)=>{
        if (!responseBody) return;
        const { code } = responseBody;
                ...
                <div className='sign-up-box'>
                    ...
                    <div className='sign-up-content-box'>
                        ...
                        <div className='sign-up-content-input-box'>
                            <InputBox ref={idRef} title='아이디' placeholder='아이디를 입력해주세요.' type='text' value={id} onChange={onIdChangeHandler} isErrorMessage={isIdError} message={idMessage} buttonTitle='중복 확인' onButtonClick={onIdButtonClickHandler} onKeydown={onIdKeyDownHandler}></InputBox>
